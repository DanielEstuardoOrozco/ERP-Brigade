        ...
        if result.get("success", False):
            ...
            try:
                with connection.cursor() as cursor:
                    ...
                    # Insert data into Tbl_Sleep
                    cursor.execute("INSERT INTO Tbl_Sleep (ID_User, Last_Modification_Date, Update_Date, Delete_Date, Active, Avg_Score, Avg_Resting_Heart_Rate, Avg_Body_Battery_Change, Avg_SPO2, Avg_Respiration) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                                   (None, None, None, None, None, 
                                    cleaned_data.get("Avg Score"), 
                                    cleaned_data.get("Avg Resting Heart Rate"), 
                                    cleaned_data.get("Avg Body Battery Change"), 
                                    cleaned_data.get("Avg SpO2"), 
                                    cleaned_data.get("Avg Respiration")))
